...
Pantheon Local Tools does not contain built-in `DFW`, `CFW`, `college`, `config/sync`, or other organization-specific names. Those are valid real-world proving-ground values only when the user configures them locally.
